...
class Settings(BaseSettings):
    ...
    def apply_updates(self, updates: dict) -> dict:
        ...
        field_map = {
            ...
            # API Keys (Updateable via Settings)
            "openrouter_api_key":           ("OPENROUTER_API_KEY",           "openrouter_api_key",           str),
            "gemini_api_key":               ("GEMINI_API_KEY",               "gemini_api_key",               str),
            "grok_api_key":                 ("GROK_API_KEY",                 "grok_api_key",                 str),
            "pexels_api_key":               ("PEXELS_API_KEY",               "pexels_api_key",               str),
            "pixabay_api_key":              ("PIXABAY_API_KEY",              "pixabay_api_key",              str),
            "jamendo_client_id":            ("JAMENDO_CLIENT_ID",            "jamendo_client_id",            str),
            "acoustid_api_key":             ("ACOUSTID_API_KEY",             "acoustid_api_key",             str),
            "huggingface_token":            ("HUGGINGFACE_TOKEN",            "huggingface_token",            str),
            "amazon_pa_api_key":            ("AMAZON_PA_API_KEY",            "amazon_pa_api_key",            str),
            "amazon_pa_secret":             ("AMAZON_PA_SECRET",             "amazon_pa_secret",             str),
            "amazon_affiliate_tag":         ("AMAZON_AFFILIATE_TAG",         "amazon_affiliate_tag",         str),
            "reddit_client_id":             ("REDDIT_CLIENT_ID",             "reddit_client_id",             str),
            "reddit_secret":                ("REDDIT_SECRET",                "reddit_secret",                str),
            "news_api_key":                 ("NEWS_API_KEY",                 "news_api_key",                 str),
